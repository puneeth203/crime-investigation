...
JSONArray jsonArray=(JSONArray)hs.getAttribute("ads");
%>		
  	</head>
	...
	<body>
			...
			<div>
			<div style="border:1px solid #C9DB25;background-color:black;color:white;font-size:25px;padding:20px;font-family:Square721 Ex BT;letter-spacing:2px;word-spacing:3px;text-align:center;">Advertisements</div></br></br>
			<center>
				...
				%>
				<a href="<%=link %>"><img src="<%=image %>" style="height: 300px;width: 300px"/><br><%=ad %></a><br/><br/>
			   <%}%>
			</center>	
			</div>
